...
public class ReportController {
    ...
    public Result getMemberReport() throws Exception {
        ...
        try {
            for (int i = 0; i < 12; i++) {
                ...
                Integer Count = memberService.getMemberReport(date);
    ...
    public Result getSetmealReport() throws Exception {
        ...
        try {
            List<Map> setmealCount = setmealService.findSetmealReport();
            ...
            e.printStackTrace();
            return new Result(true, MessageConstant.QUERY_SETMEAL_FAIL, map);
        }
